...
HD_PWD='D:/working/systemverilog/2025_11_14_test_slave/2025_11_14_test_slave.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_I2C_Slave.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_I2C_Slave.tcl
