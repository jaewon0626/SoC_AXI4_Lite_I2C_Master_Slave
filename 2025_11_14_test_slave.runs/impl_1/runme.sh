...
HD_PWD='D:/working/systemverilog/2025_11_14_test_slave/2025_11_14_test_slave.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_I2C_Slave.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_I2C_Slave.tcl -notrace
