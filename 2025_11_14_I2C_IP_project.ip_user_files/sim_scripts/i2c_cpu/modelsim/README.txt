...
#
# Generated by export_simulation on Fri Nov 14 15:18:15 +0900 2025
#
################################################################################
...
'-reset_run' switch to the './i2c_cpu.sh' script.

./i2c_cpu.sh -reset_run
...
./i2c_cpu.sh -noclean_files

For more information on the script, please type './i2c_cpu.sh -help'.
