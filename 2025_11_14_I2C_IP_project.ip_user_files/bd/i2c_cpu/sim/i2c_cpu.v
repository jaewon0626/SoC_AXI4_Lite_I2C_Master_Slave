...
//Command     : generate_target i2c_cpu.bd
//Design      : i2c_cpu
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "i2c_cpu,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=i2c_cpu,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=23,numReposBlks=15,numNonXlnxBlks=0,numHierBlks=8,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=10,da_board_cnt=7,da_mb_cnt=3,synth_mode=Global}" *) (* HW_HANDOFF = "i2c_cpu.hwdef" *) 
module i2c_cpu
   (SCL_0,
    SDA_0,
    btn,
  ...
  inout [7:0]sw;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.SYS_CLOCK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.SYS_CLOCK, CLK_DOMAIN i2c_cpu_sys_clock, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000" *) input sys_clock;
  ...
  i2c_cpu_clk_wiz_1_1 clk_wiz_1
       (.clk_in1(sys_clock_1),
        .clk_out1(microblaze_0_Clk_2),
        .locked(clk_wiz_1_locked),
        .reset(reset_1));
  i2c_cpu_gpio_0_0 gpio_0
       (.io_port(btn[7:0]),
        .s00_axi_aclk(microblaze_0_Clk_2),
  ...
  i2c_cpu_i2c_master_0_0 i2c_master_0
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > i2c_cpu microblaze_0_local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  i2c_cpu_microblaze_0_2 microblaze_0
  ...
  i2c_cpu_microblaze_0_axi_periph_1 microblaze_0_axi_periph
       (.ACLK(microblaze_0_Clk_2),
        .ARESETN(rst_clk_wiz_1_100M_peripheral_aresetn1),
  ...
  microblaze_0_local_memory_imp_A232KH microblaze_0_local_memory
  ...
  i2c_cpu_rst_clk_wiz_1_100M_1 rst_clk_wiz_1_100M
       (.aux_reset_in(1'b1),
...
module i2c_cpu_microblaze_0_axi_periph_1
   (ACLK,
    ARESETN,
    M00_ACLK,
    M00_ARESETN,
  ...
  m00_couplers_imp_11IVIHT m00_couplers
  ...
  m01_couplers_imp_62RKY m01_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
  ...
  m02_couplers_imp_N14YP2 m02_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
  ...
  m03_couplers_imp_1N04R8L m03_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
  ...
  m04_couplers_imp_1VRBTTA m04_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
  ...
  s00_couplers_imp_3APP s00_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
...
module m00_couplers_imp_11IVIHT
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module m02_couplers_imp_N14YP2
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arprot,
...
module m03_couplers_imp_1N04R8L
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arprot,
...
module m04_couplers_imp_1VRBTTA
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arprot,
...
module microblaze_0_local_memory_imp_A232KH
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > i2c_cpu microblaze_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  i2c_cpu_dlmb_bram_if_cntlr_1 dlmb_bram_if_cntlr
  ...
  i2c_cpu_dlmb_v10_1 dlmb_v10
       (.LMB_ABus(microblaze_0_dlmb_bus_ABUS),
        ...
        .Sl_UE(microblaze_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_0_dlmb_bus_WAIT));
  i2c_cpu_ilmb_bram_if_cntlr_1 ilmb_bram_if_cntlr
