...
HD_PWD='D:/working/systemverilog/2025_11_14_I2C_IP_project/2025_11_14_I2C_IP_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_cpu_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source i2c_cpu_wrapper.tcl -notrace
