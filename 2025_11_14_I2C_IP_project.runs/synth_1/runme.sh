...
HD_PWD='D:/working/systemverilog/2025_11_14_I2C_IP_project/2025_11_14_I2C_IP_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_cpu_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2c_cpu_wrapper.tcl
